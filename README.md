...
Desde mis primeras clases, he sentido una gran curiosidad por entender cómo se ve la economía en los datos del mundo real. Me di cuenta de que las discusiones más interesantes no se basan en opiniones, sino en evidencia.
...
Actualmente estoy desarrollando mis habilidades en las siguientes herramientas:
...
Aquí documento los ejercicios y pequeños proyectos que desarrollo para aplicar lo que aprendo en mis cursos.

- **[Proyecto en Curso 1: Exploración de Datos Públicos]**:
  - **Objetivo:** Familiarizarme con los microdatos de la Gran Encuesta Integrada de Hogares (GEIH) del DANE.
  - **Actividades:** Uso de `Pandas` para cargar, limpiar y describir las variables principales del dataset. Creación de visualizaciones básicas con `Matplotlib` para entender la distribución de ingresos y niveles educativos.

- **[Próximo Objetivo: Replicación de Ejercicio de Clase]**:
